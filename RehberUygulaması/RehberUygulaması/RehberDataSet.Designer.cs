            ...
            public string MAIL {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("\'Kisiler\' tablosundaki \'MAIL\' sütunun değeri DBNull.", e);
                    }
                }
                set {
...
namespace RehberUygulaması.RehberDataSetTableAdapters {
    ...
    public partial class KisilerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Kisiler] ([AD], [SOYAD], [TELEFON], [MAIL]) VALUES (@AD, @SOYA" +
                "D, @TELEFON, @MAIL);\r\nSELECT ID, AD, SOYAD, TELEFON, MAIL FROM Kisiler WHERE (ID" +
                " = SCOPE_IDENTITY())";
...
SELECT ID, AD, SOYAD, TELEFON, MAIL FROM Kisiler WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::RehberUygulaması.Properties.Settings.Default.RehberConnectionString;
        }
        ...
        public virtual int Fill(RehberDataSet.KisilerDataTable dataTable) {
        ...
        public virtual RehberDataSet.KisilerDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            RehberDataSet.KisilerDataTable dataTable = new RehberDataSet.KisilerDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(RehberDataSet.KisilerDataTable dataTable) {
